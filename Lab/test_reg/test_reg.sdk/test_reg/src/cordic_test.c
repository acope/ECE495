...
#define SLV_REG0 MYIP_S00_AXI_SLV_REG0_OFFSET
#define SLV_REG1 MYIP_S00_AXI_SLV_REG1_OFFSET
...
int main(void){
	...
	MYIP_mWriteReg(MYCORDIC_BASE,SLV_REG0,0x26DC0000);

	//for (Delay = 0; Delay < DELAY; Delay++);
	valueXY = MYIP_mReadReg (MYCORDIC_BASE,SLV_REG1);


	xil_printf("ValueXY = %08X", 0x5678);
/*
